...
if OPENAI_API_KEY:
    ...
    client = None
    st.info("LLM features disabled (No API key found).")

# ---------------- LANGUAGE INPUT ----------------
language = st.text_input("Enter output language (English, Hindi, Arabic, etc.)", value="English")
